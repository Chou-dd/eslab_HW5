...
public:
    ...
    ButtonService(BLE &_ble, long long int buttonPressedInitial) :
    ...
    void updateButtonState(long long int newState) {
        ble.gattServer().write(buttonState.getValueHandle(), (uint8_t *)&newState, sizeof(long long int));
    }

private:
    BLE                              &ble;
    ReadOnlyGattCharacteristic<long long int>  buttonState;
